      ...
      <section className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <p className="max-w-2xl text-lg text-muted-foreground">
            This starter stitches together Next.js, Drizzle ORM, Neon, Tailwind CSS, and the OpenAI
            Agents SDK so you can focus on application logic instead of boilerplate.
          </p>
        </div>
      </section>
